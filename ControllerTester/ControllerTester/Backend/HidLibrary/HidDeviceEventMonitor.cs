...
namespace HidLibrary {
    ...
    internal class HidDeviceEventMonitor {
        ...
        public HidDeviceEventMonitor(HidDevice device) { _device = device; }
        ...
        private static void DisposeDeviceEventMonitor(IAsyncResult ar) { ((Action)ar.AsyncState).EndInvoke(ar); }
    }
